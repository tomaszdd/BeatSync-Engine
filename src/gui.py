...
def _store_render_plan(*, beat_info: dict, output_path: str, audio_file: str,
                       ...
                       strict_unique_non_overlap: bool, edge_buffer_seconds: float,
                        ...
                        vertical_crop_focus: str = VERTICAL_CROP_AUTO_SMALLER,
    ...
    try:
        ...
        try:
            result_path = create_music_video(
                ...
                vertical_crop_focus=plan.get('vertical_crop_focus', VERTICAL_CROP_AUTO_SMALLER),
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                with gr.Group():
                    ...
                    min_subject_confidence = gr.Slider(
                    ...
                    vertical_crop_focus = gr.Radio(
                        choices=VERTICAL_CROP_FOCUS_CHOICES,
                        value=VERTICAL_CROP_AUTO_SMALLER,
                        label=LABEL_VERTICAL_CROP_FOCUS,
                        info=INFO_VERTICAL_CROP_FOCUS,
                    )
